  ...
  return (
    ...
    >
      <div className="px-3 sm:px-4 md:px-11 lg:px-13 xl:px-14 2xl:px-16">
        <div className="flex justify-center items-center flex-col  z-[1] h-screen">
            <h1 className="mb-15 ">Contact Us </h1>
            <form className="rounded-[30px] shadow-2xl  lg:w-[60%] w-[70%] items-center bg-[#fff] pt-10 ">
                ...
                <div className="mx-5 md:mx-20">
                    ...
                    <textarea className="w-full" name="message" id="" placeholder="Send Us Your Problem or Feedback etc..."/>
                </div>
            </form>
        </div>
      </div>
